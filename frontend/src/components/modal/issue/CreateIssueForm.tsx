...
import { useCreateIssue } from "@/query/mutations/issue";
...
export function CreateIssueForm({
  ...
  const createIssueMutation = useCreateIssue(projectId, milestone.id);

  const [formData, setFormData] = useState({
    title: "",
    content: "",
    category: "FE", // 'FE' | 'BE'
    label: "feature", // 'feature' | 'refactor' | 'bug' | 'setting' | 'test'
    branch: "",
    expected_results: "",
    start_date: "",
    end_date: "",
  ...
  const validateForm = (): boolean => {
    ...
    //   newErrors.assignee_ids = "담당자를 선택해주세요.";
