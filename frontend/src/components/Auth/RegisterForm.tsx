...
export default function RegisterFormComponent() {
  ...
  const validateForm = (): boolean => {
    const newErrors: ValidationErrors = {
      name: registerValidation.name(formData.name),
      email: registerValidation.email(formData.email),
      password: registerValidation.password(formData.password),
      phoneNumber: registerValidation.phoneNumber(formData.phoneNumber),
      githubUrl: registerValidation.githubUrl(formData.githubUrl),
