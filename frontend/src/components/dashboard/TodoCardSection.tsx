...
import { ChevronRight, List, Milestone as MilestoneIcon } from "lucide-react";
        ...
        {!milestones || milestones.length === 0 ? (
          ...
          milestones.map((milestone: Milestone) => (
            <div key={milestone.id} className="mb-1">
              <div className="flex justify-between border p-2 rounded hover:bg-gray-50 cursor-pointer">
                <div
        ...
        {!issues || issues.length === 0 ? (
          ...
          issues.map((issue: Issue) => (
            <div
              ...
              className="mb-1"
            >
              <div className="flex items-center gap-2 border bg-gray-50 text-sm text-gray-600 bg-white p-2 rounded-md hover:bg-green-50 transition-colors cursor-pointer">
                <h3 className="flex text-sm font-bold text-blue-400">
                  <List size={20} className="mr-1" /> 이슈
                </h3>
